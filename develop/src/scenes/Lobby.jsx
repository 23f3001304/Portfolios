...
const BLURBS = {
  livon: "Livon is a life tracker that keeps your whole day in one place: food, sleep, routine, lifts and walks, plus a coach that reads all of it. The record lives on your device, so logging a day needs no server at all. It can look like twenty-five different apps depending on which family you wear. You can type a meal or a workout the way you'd say it, and it proposes the entries for you to confirm. Tauri on the desktop, Kotlin on Android and the watch.",
  saathi: "Saathi is a shopping agent that cannot spend your money outside a mandate you signed. Ask for a navy kurta under two thousand rupees, refundable - it drafts the intent, you hold to sign, and only then does it go looking. Every rupee moves through an AP2 mandate chain and a hash-chained ledger: eight checks before a paisa moves, three live attacks blocked out of three, and zero sales lost to a false block.",
  tcursor: "TCursor is a screen recorder that gives you a beautiful edit without doing any editing. It watches every click and keystroke while you record, so smart auto-zoom punches in exactly where you were working, layout hotkeys move the webcam and the stage mid-take, and a local AI director trims the dead air. Nothing is baked into the file - every zoom is still a pill on the timeline you can drag. Rust, Tauri and a wgpu compositor underneath.",
